# online-market-data-providers Specification

## Purpose
Define common online bars and board discovery contracts for TDX, THS and Eastmoney, with explicit source identities, validated data ranges and isolated HTTP/CLI access.
